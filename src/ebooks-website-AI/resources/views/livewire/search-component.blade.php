                            ...
                            <div class="sort-by-product-area">
                                <div class="sort-by-cover mr-10">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            <li><a class="{{ $pagesize == 12 ? 'active' : '' }}" href="javascript:void(0)" wire:click="changepageSize(12)">12</a></li>
                                            <li><a class="{{ $pagesize == 24 ? 'active' : '' }}" href="javascript:void(0)" wire:click="changepageSize(24)">24</a></li>
                                            <li><a class="{{ $pagesize == 36 ? 'active' : '' }}" href="javascript:void(0)" wire:click="changepageSize(36)">36</a></li>
                                            <li><a class="{{ $pagesize == 48 ? 'active' : '' }}" href="javascript:void(0)" wire:click="changepageSize(48)">48</a></li>
                                            <li><a class="{{ $pagesize == 50 ? 'active' : '' }}" href="javascript:void(0)" wire:click="changepageSize(50)">50</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="sort-by-cover">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            <li><a class="{{ $orderBy == 'Mặc định' ? 'active' : '' }}" href="javascript:void(0)" wire:click="changeOrderBy('Mặc định')">Mặc định</a></li>
                                            <li><a class="{{ $orderBy == 'Giá thấp' ? 'active' : '' }}" href="javascript:void(0)" wire:click="changeOrderBy('Giá thấp')">Giá thấp</a></li>
                                            <li><a class="{{ $orderBy == 'Giá cao' ? 'active' : '' }}" href="javascript:void(0)" wire:click="changeOrderBy('Giá cao')">Giá cao</a></li>
                                            <li><a class="{{ $orderBy == 'Sản phẩm mới' ? 'active' : '' }}" href="javascript:void(0)" wire:click="changeOrderBy('Sản phẩm mới')">Sản phẩm mới</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="product-price" style="font-size: 14px; display: flex; flex-wrap: wrap; align-items: center; gap: 5px;">
                                            @if($product->sale_price && $product->sale_price > 0 && $product->sale_price < $product->reguler_price)
                                                <div style="display: flex; align-items: center; gap: 5px; flex-wrap: nowrap;">
                                                    ...
                                                    @if($product->reguler_price > 0)
                                                    @else
                                                    <span style="display: none;"></span>
                                                    @endif
                                                </div>
                                                <div style="margin-top: 5px;">
                                                    <span style="text-decoration: line-through; color: #999; font-size: 12px;">{{ number_format($product->reguler_price, 3, ',', '.') }}đ</span>
                                                </div>
                                                @else
